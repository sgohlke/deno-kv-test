export {
   Person,
   PersonService,
} from 'https://raw.githubusercontent.com/sgohlke/ModPersonServiceDeno/1.0.16/personservice.ts'
export {
   assertEquals,
} from 'https://raw.githubusercontent.com/sgohlke/deno-web/6.0.0/deps.ts'
